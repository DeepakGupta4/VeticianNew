...
const ClinicDetailScreen = () => {
  ...
  const clinicData = {
    clinicDetails: {
      clinicId: params.clinicId || params.clinicName,
  ...
  if (!params.clinicId && !params.clinicName) {
    return (
        ...
        <View style={styles.profileSection}>
          <View style={styles.profileRow}>
            ...
            <View style={styles.doctorMainInfo}>
              ...
              <Text style={styles.qualifications}>BVSc, MVSc - {vet.specialization || 'Veterinary Medicine'}</Text>
              <Text style={styles.specialties}>{vet.specialization || 'General Practice'}</Text>
          ...
          <Text style={styles.shortBio}>
            ...
            Specializing in {vet.specialization}, the doctor provides high-quality medical care at {clinicDetails.clinicName}.
            {vet.experience ? ` With ${vet.experience} years of experience, ` : ' '}dedicated to the health and well-being of your pets.
          </Text>
        </View>
          ...
          <View style={styles.clinicCard}>
            <View style={styles.clinicDetailsLeft}>
              ...
              <Text style={styles.fullAddress}>
                {clinicDetails.streetAddress || 'Address not specified'}, {clinicDetails.locality}{clinicDetails.locality ? ',' : ''} Landmark: {clinicDetails.city}.
              </Text>
