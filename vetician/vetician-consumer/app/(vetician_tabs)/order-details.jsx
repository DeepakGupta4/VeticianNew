...
const styles = StyleSheet.create({
  safe: { flex: 1, backgroundColor: G.dark },
  scroll: { flex: 1 },
  content: { flexGrow: 1, backgroundColor: '#F0F4EE' },
  hero: {
    backgroundColor: G.base, paddingBottom: 36,
    paddingHorizontal: 20, alignItems: 'center', overflow: 'hidden',
  },
  circle1: { position: 'absolute', width: 200, height: 200, borderRadius: 100, backgroundColor: G.tint, top: -60, right: -50 },
  circle2: { position: 'absolute', width: 140, height: 140, borderRadius: 70, backgroundColor: G.tint, bottom: -40, left: -30 },
  navRow: { flexDirection: 'row', alignItems: 'center', width: '100%', paddingTop: 14, paddingBottom: 24, gap: 12 },
  iconBtn: {
    width: 38, height: 38, borderRadius: 12, backgroundColor: G.tint,
    borderWidth: 1, borderColor: G.border, alignItems: 'center', justifyContent: 'center',
  },
  navTitle: { flex: 1, fontSize: 17, fontWeight: '700', color: '#fff', letterSpacing: -0.2, textAlign: 'center' },
  heroIconRing: {
  ...
  heroIconInner: { width: 64, height: 64, borderRadius: 32, backgroundColor: G.mid, alignItems: 'center', justifyContent: 'center' },
  heroService: { fontSize: 22, fontWeight: '800', color: '#fff', letterSpacing: -0.4, marginBottom: 4, textAlign: 'center' },
  heroId: { fontSize: 12, color: 'rgba(255,255,255,0.6)', letterSpacing: 0.8, marginBottom: 14, fontWeight: '500' },
  ...
  statsStrip: {
    flexDirection: 'row', backgroundColor: G.dark, borderRadius: 16,
  ...
  body: { backgroundColor: '#F0F4EE', borderTopLeftRadius: 24, borderTopRightRadius: 24, marginTop: -20, paddingTop: 8 },
});
