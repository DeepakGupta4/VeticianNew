...
export default function Profile() {
  ...
  const uploadToCloudinary = async (file) => {
    ...
    try {
      ...
      formDataObj.append('upload_preset', 'vetician');
      formDataObj.append('cloud_name', 'dqwzfs4ox');
      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
          ...
          <Card style={styles.profileCard}>
              ...
              <View style={styles.profileHeader}>
                <View style={styles.profileLeft}>
                  {parentData?.image ? (
                    ...
                    <Surface style={styles.profileAvatarPlaceholder}>
                      <User size={32} color="#64748B" />
                    </Surface>
                  )}
                  <View style={styles.profileInfo}>
                    <Text variant="headlineSmall" style={styles.profileName}>
                      {parentData?.name || user?.name || 'Pet Parent'}
                    </Text>
                    <Text variant="bodySmall" style={styles.profilePhone}>
                      {parentData?.phone || 'Not provided'}
                    </Text>
                    {!parentData?.address && (
                      <Text style={styles.profileWarning}>⚠️ Address required</Text>
                    )}
            ...
            {/* Rating Section */}
            <TouchableOpacity style={styles.ratingSection} activeOpacity={0.7}>
              <Star size={24} color="#F59E0B" fill="#F59E0B" />
              <Text variant="bodyLarge" style={styles.ratingText}>
                {averageRating.toFixed(2)} My Rating
              </Text>
              <View style={styles.chevronButton}>
                <Text style={styles.chevronIcon}>›</Text>
              </View>
