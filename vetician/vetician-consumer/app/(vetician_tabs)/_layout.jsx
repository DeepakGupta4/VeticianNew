...
export default function Layout() {
  return (
    <Stack>
      ...
      <Stack.Screen name="pet-care-tip-details"           options={{ headerShown: false }} />
      ...
      <Stack.Screen name="profile-sections"               options={{ headerShown: false }} />
      <Stack.Screen name="vet-details/[id]"               options={{ headerShown: false }} />

      {/* ── Pages ── */}
      <Stack.Screen name="pages/VeticianWelcomeScreen"    options={{ headerShown: false }} />
      ...
      <Stack.Screen name="pages/BookingDetails"           options={{ headerShown: false }} />
      <Stack.Screen name="pages/City"                     options={{ headerShown: false }} />
      ...
      <Stack.Screen name="pages/HealthTipsScreen"         options={{ headerShown: false }} />
      ...
      <Stack.Screen name="pages/ParavetBookings"          options={{ headerShown: false }} />
      <Stack.Screen name="pages/ParavetDetailScreen"      options={{ headerShown: false }} />
      <Stack.Screen name="pages/ParavetListScreen"        options={{ headerShown: false }} />
      ...
      <Stack.Screen name="pages/VideoCallScreen"          options={{ headerShown: false }} />
      <Stack.Screen name="pages/VideoConsultation"        options={{ headerShown: false }} />
    </Stack>
  );
}
