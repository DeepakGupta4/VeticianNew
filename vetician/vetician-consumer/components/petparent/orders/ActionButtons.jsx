...
const styles = StyleSheet.create({
  ...
  body: { padding: 14, gap: 10, backgroundColor: '#fff' },
  row: { flexDirection: 'row', gap: 10 },
  btnPrimary: {
    flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    gap: 7, backgroundColor: COLORS2.primary, paddingVertical: 14, borderRadius: 12,
  },
  btnPrimaryText: { fontSize: 14, fontWeight: '700', color: '#fff' },
  btnOutline: {
    flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    gap: 7, backgroundColor: COLORS2.accent, borderWidth: 1.5, borderColor: COLORS2.shadow,
    paddingVertical: 14, borderRadius: 12,
  },
  btnOutlineText: { fontSize: 14, fontWeight: '600', color: COLORS2.primary },
  btnInvoice: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    gap: 7, backgroundColor: COLORS2.accent, borderWidth: 1.5, borderColor: COLORS2.shadow,
    paddingVertical: 14, borderRadius: 12,
  },
  btnInvoiceText: { fontSize: 14, fontWeight: '600', color: COLORS2.primary },
});
