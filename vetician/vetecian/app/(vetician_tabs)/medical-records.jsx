...
import { Stethoscope, Heart, BookOpen, Package, Users, Gift, Bell, HelpCircle, Settings as SettingsIcon, ChevronLeft } from 'lucide-react-native';
...
export default function MedicalRecords() {
  ...
  return (
    <View style={styles.container}>
      <Header title="Medical Records" router={router} />
      <View style={styles.content}>
        <Stethoscope size={80} color="#10B981" />
        <Text style={styles.title}>Medical Records</Text>
        <Text style={styles.subtitle}>Pet health history and documents</Text>
