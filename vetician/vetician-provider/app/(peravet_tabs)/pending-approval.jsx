...
export default function ParavetPendingApproval() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <Text style={styles.subtitle}>
        Your paravet profile has been submitted successfully. Our admin will review your documents and activate your account within 7 business days.
      </Text>
...
const styles = StyleSheet.create({
  ...
  stepsCard: {
    ...
    padding: 20, marginBottom: 20, borderWidth: 1, borderColor: '#E5E7EB', gap: 16,
  },
  ...
  infoBox: {
    width: '100%', flexDirection: 'row', backgroundColor: '#EFF6FF',
    borderRadius: 12, padding: 16, gap: 10, marginBottom: 28, alignItems: 'flex-start',
  },
  infoText: { flex: 1, fontSize: 13, color: '#1D4ED8', lineHeight: 20 },
  checkBtn: {
    width: '100%', backgroundColor: '#10B981', borderRadius: 12,
  ...
  editBtn: {
    width: '100%', borderWidth: 1.5, borderColor: '#4A90E2', borderRadius: 12,
